...
const GenericTable = ({ title, fetchData, createItem, deleteItem, itemFields, itemKey }) => {
    ...
    const filterItems = (term) => {
        const filtered = items.filter(item =>
            item[itemKey].toString().includes(term) || item.name.toLowerCase().includes(term.toLowerCase())
        );
    ...
    const handleItemInputChange = (key, value) => {
                                ...
                                <Row>
                                    <Form>
                                        <Form.Group controlId="formItemInput">
                                            ...
                                            />
                                            <Button className='mt-3' onClick={handleCreateItem}>Add Item</Button>
                                        </Form.Group>
                                    </Form>
                                </Row>
                            </Card.Body>
