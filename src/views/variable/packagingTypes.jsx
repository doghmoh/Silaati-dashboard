...
import { hanldeDeletePackagingType, hanldeGetAllPackagingType } from 'apis/other';
...
const PackagingTypes = () => {
    ...
    const fetchProfileData = async () => {
        ...
        setError('');
        try {
            const response = await hanldeGetAllPackagingType();
            if (response.data) {
    ...
    const handleDeleteProduct = async (productId) => {
        ...
        setConfirmAction(() => async () => {
            setLoading(true);
            try {
                await hanldeDeletePackagingType(productId);
