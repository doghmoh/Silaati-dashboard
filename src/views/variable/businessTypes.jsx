...
import { hanldeDeleteBusinessType, hanldeGetAllBusinessType } from 'apis/other';
...
const BusinessTypes = () => {
    ...
    const fetchProfileData = async () => {
        ...
        setError('');
        try {
            const response = await hanldeGetAllBusinessType();
            if (response.data) {
    ...
    const handleDeleteProduct = async (productId) => {
        ...
        setConfirmAction(() => async () => {
            setLoading(true);
            try {
                await hanldeDeleteBusinessType(productId);
